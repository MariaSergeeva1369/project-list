...
var menuHandler = function menuHandler() {
  if (!_utils_utils__WEBPACK_IMPORTED_MODULE_2__["breakpoint"].matches) {
...
var navBreakpointChecker = function navBreakpointChecker() {
  if (_utils_utils__WEBPACK_IMPORTED_MODULE_2__["breakpoint"].matches && navMenu.classList.contains('is-opened')) {
    closeMenu();
  }
};
_utils_utils__WEBPACK_IMPORTED_MODULE_2__["breakpoint"].addEventListener('change', navBreakpointChecker);
...
var setClass = function setClass(_ref, params) {
  ...
  for (var _i2 = 0, _Object$values2 = Object.values(params); _i2 < _Object$values2.length; _i2++) {
    ...
    if (_utils_utils__WEBPACK_IMPORTED_MODULE_0__["breakpoint"].matches) {
...
_utils_utils__WEBPACK_IMPORTED_MODULE_0__["breakpoint"].addEventListener('change', sortListBreakpointChecker);
...
/*!***************************!*\
  !*** ./js/utils/utils.js ***!
  \***************************/
/*! exports provided: breakpoint, breakpointDesk, isEscapeKey, removeNojsClass */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
