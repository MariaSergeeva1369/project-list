...
/* harmony import */ var _modules_sort_list__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./modules/sort-list */ "./js/modules/sort-list.js");
...
window.addEventListener('DOMContentLoaded', function () {
  ...
  // Modules
  Object(_utils_utils__WEBPACK_IMPORTED_MODULE_5__["removeNojsClass"])(_modules_navigation__WEBPACK_IMPORTED_MODULE_2__["navMenu"]);
  Object(_utils_utils__WEBPACK_IMPORTED_MODULE_5__["removeNojsClass"])(_modules_accordion__WEBPACK_IMPORTED_MODULE_4__["skillsContainers"]);
  Object(_utils_utils__WEBPACK_IMPORTED_MODULE_5__["removeNojsClass"])(_modules_slider__WEBPACK_IMPORTED_MODULE_1__["sliderControlContainer"]);
  Object(_utils_utils__WEBPACK_IMPORTED_MODULE_5__["removeNojsClass"])(_modules_sort_list__WEBPACK_IMPORTED_MODULE_3__["buttonContainer"]);
  Object(_modules_navigation__WEBPACK_IMPORTED_MODULE_2__["navInit"])();
  Object(_modules_accordion__WEBPACK_IMPORTED_MODULE_4__["accordionInit"])();
  Object(_modules_slider__WEBPACK_IMPORTED_MODULE_1__["setSliderAttribute"])();
  Object(_modules_sort_list__WEBPACK_IMPORTED_MODULE_3__["sortListInit"])();
  // ---------------------------------
...
/*!*********************************!*\
  !*** ./js/modules/accordion.js ***!
  \*********************************/
/*! exports provided: skillsContainers, accordionBreakpointChecker, accordionInit */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "skillsContainers", function() { return skillsContainers; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "accordionBreakpointChecker", function() { return accordionBreakpointChecker; });
...
var skillsContainers = document.querySelectorAll('[data-setting-name="skills"]');
var skillsClickHandler = function skillsClickHandler(evt) {
  var skillsContainer = evt.target.closest('div');
  skillsContainer.classList.toggle('is-closed');
  skillsContainer.classList.toggle('is-opened');
  var button = skillsContainer.querySelector('button');
  var buttonTextContainer = button.querySelector('span');
...
var accordionInit = function accordionInit() {
  if (!_utils_utils__WEBPACK_IMPORTED_MODULE_0__["breakpointDesk"].matches && skillsContainers && skillsContainers.length > 0) {
    skillsContainers.forEach(function (skillContainer) {
      return skillContainer.addEventListener('click', skillsClickHandler);
    });
  }
};
var accordionBreakpointChecker = function accordionBreakpointChecker() {
  if (!_utils_utils__WEBPACK_IMPORTED_MODULE_0__["breakpointDesk"].matches) {
    accordionInit();
  } else {
    skillsContainers.forEach(function (skillContainer) {
      return skillContainer.removeEventListener('click', skillsClickHandler);
    });
  }
};
_utils_utils__WEBPACK_IMPORTED_MODULE_0__["breakpointDesk"].addEventListener('change', accordionBreakpointChecker);
...
/*!**********************************!*\
  !*** ./js/modules/navigation.js ***!
  \**********************************/
/*! exports provided: navInit, navMenu */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
var navMenu = document.querySelector('[data-setting-name="navigation"]');
var headerElement = document.querySelector('[data-setting-name="header"]');
...
var closeMenulOnEscape = function closeMenulOnEscape(evt) {
  if (Object(_utils_utils__WEBPACK_IMPORTED_MODULE_2__["isEscapeKey"])(evt)) {
    evt.preventDefault();
    closeMenu();
    document.removeEventListener('keydown', closeMenulOnEscape);
  }
};
var setLinkAttribute = function setLinkAttribute() {
  var linkContainers = navMenu.querySelectorAll('a');
  if (!_utils_utils__WEBPACK_IMPORTED_MODULE_2__["breakpointTablet"].matches) {
    if (navMenu.classList.contains('is-closed')) {
      linkContainers.forEach(function (link) {
...
var applySettings = function applySettings() {
  var textContainer = navMenu.querySelector('span');
...
var navBreakpointChecker = function navBreakpointChecker() {
  if (_utils_utils__WEBPACK_IMPORTED_MODULE_2__["breakpointTablet"].matches && navMenu.classList.contains('is-opened')) {
    closeMenu();
  }
  setLinkAttribute();
};
_utils_utils__WEBPACK_IMPORTED_MODULE_2__["breakpointTablet"].addEventListener('change', navBreakpointChecker);
...
/*!******************************!*\
  !*** ./js/modules/slider.js ***!
  \******************************/
/*! exports provided: setSliderAttribute, sliderControlContainer */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "setSliderAttribute", function() { return setSliderAttribute; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "sliderControlContainer", function() { return sliderControlContainer; });
...
var sliderControlContainer = document.querySelector('[data-setting-name="slider-control-container"]');
...
/***/ "./js/modules/sort-list.js":
/*!*********************************!*\
  !*** ./js/modules/sort-list.js ***!
  \*********************************/
/*! exports provided: sortListInit, buttonContainer */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "sortListInit", function() { return sortListInit; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "buttonContainer", function() { return buttonContainer; });
/* harmony import */ var _utils_utils__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../utils/utils */ "./js/utils/utils.js");

var buttonContainer = document.querySelector('[data-setting-name="buttons-container"]');
var settingButtons = document.querySelectorAll('[data-setting-name="viewCard"]');
var DEFAULT_CARD_VIEW = 'is-tile';
var getDefaultButtonsParams = function getDefaultButtonsParams() {
  var button = Array.from(settingButtons).find(function (item) {
    return item.dataset['settingValue'] === DEFAULT_CARD_VIEW;
  });
  var buttonsParams = {};
  var _button$dataset = button.dataset,
    settingName = _button$dataset.settingName,
    settingValue = _button$dataset.settingValue;
  buttonsParams[settingName] = settingValue;
  return buttonsParams;
};
var setActiveButton = function setActiveButton(params) {
  var _loop = function _loop() {
    var value = _Object$values[_i];
    var activeButton = Array.from(settingButtons).find(function (button) {
      return button.classList.contains('active');
    });
    activeButton.classList.remove('active');
    var setButton = Array.from(settingButtons).find(function (button) {
      return button.dataset['settingValue'] === value;
    });
    setButton.classList.add('active');
  };
  for (var _i = 0, _Object$values = Object.values(params); _i < _Object$values.length; _i++) {
    _loop();
  }
};
var setClass = function setClass(_ref, params) {
  var settingTarget = _ref.settingTarget;
  var targetElement = document.querySelector(settingTarget);
  for (var _i2 = 0, _Object$values2 = Object.values(params); _i2 < _Object$values2.length; _i2++) {
    var value = _Object$values2[_i2];
    var buttonElements = Array.from(settingButtons);
    buttonElements.forEach(function (item) {
      return targetElement.classList.remove(item.dataset.settingValue);
    });
    if (_utils_utils__WEBPACK_IMPORTED_MODULE_0__["breakpointTablet"].matches) {
...
var settingButtonClickHandler = function settingButtonClickHandler(evt, setting) {
  ...
  var _button$dataset2 = button.dataset,
    settingName = _button$dataset2.settingName,
    settingValue = _button$dataset2.settingValue;
  params[settingName] = settingValue;
  setClass(setting, params);
};
var sortListInit = function sortListInit() {
  var setting = buttonContainer.dataset;
  buttonContainer.addEventListener('click', function (evt) {
    settingButtonClickHandler(evt, setting);
  });
};
var sortListBreakpointChecker = function sortListBreakpointChecker() {
  if (buttonContainer) {
    var setting = buttonContainer.dataset;
    if (!_utils_utils__WEBPACK_IMPORTED_MODULE_0__["breakpointTablet"].matches) {
...
_utils_utils__WEBPACK_IMPORTED_MODULE_0__["breakpointTablet"].addEventListener('change', sortListBreakpointChecker);
...
/*!***************************!*\
  !*** ./js/utils/utils.js ***!
  \***************************/
/*! exports provided: breakpointTablet, breakpointDesk, isEscapeKey, removeNojsClass */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "breakpointTablet", function() { return breakpointTablet; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "breakpointDesk", function() { return breakpointDesk; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "isEscapeKey", function() { return isEscapeKey; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "removeNojsClass", function() { return removeNojsClass; });
var breakpointTablet = window.matchMedia('(min-width: 768px)');
var breakpointDesk = window.matchMedia('(min-width: 1024px)');
var isEscapeKey = function isEscapeKey(evt) {
  return evt.key === 'Escape';
};
var removeNojsClass = function removeNojsClass(elements) {
  if (elements && elements.length) {
    elements.forEach(function (element) {
      return element.classList.remove('is-nojs');
    });
