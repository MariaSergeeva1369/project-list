...
window.addEventListener('DOMContentLoaded', function () {
  ...
  // Modules
  Object(_modules_slider__WEBPACK_IMPORTED_MODULE_2__["setSliderAttribute"])();
  // ---------------------------------
...
/*!******************************!*\
  !*** ./js/modules/slider.js ***!
  \******************************/
/*! exports provided: setSliderAttribute */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "setSliderAttribute", function() { return setSliderAttribute; });
...
var sliderCertificatesList = document.querySelector('.swiper');
var activeSlides = document.getElementsByClassName('swiper-slide-active');
if (sliderCertificatesList) {
  var mySwiper = new swiper__WEBPACK_IMPORTED_MODULE_0__["default"](sliderCertificatesList, {
    loop: true,
    slidesPerView: 1,
    spaceBetween: 40,
    pagination: {
...
function setSliderAttribute() {
  if (activeSlides.length >= 1) {
    var _iterator = _createForOfIteratorHelper(activeSlides),
      _step;
    try {
    ...
    var activeSlide = document.getElementById('id-active-swiper-slide');
    var activeLink = activeSlide.children;
    var _iterator2 = _createForOfIteratorHelper(activeLink),
      _step2;
    try {
